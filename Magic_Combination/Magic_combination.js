...
var new_magic_add = function(magic,star){
    ...
    $("#select_container0 , #select_container"+star).append('<input type="button" id="'+"'"+magic+"'"+'" onclick="selection_input('+"'"+magic+"'"+')" class="magic" hidden><label for="'+"'"+magic+"'"+'" style="word-break: break-all;"><img src="magic_image/'+magic+'.png" style="width:80%; height:80%;"><br>'+magic+'</label>')
}
